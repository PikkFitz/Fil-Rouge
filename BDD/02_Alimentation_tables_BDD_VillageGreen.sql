...
INSERT INTO `Commande` (`commande_id`,`commande_num`,`commande_observation`,`commande_date`,`commande_datePaiement`,`commande_facture`,`commande_infoPaiement`,`commande_documents`,`commande_reduction`)
VALUES
  (1,"E1B7E146-BED8-B7A4-8623-F6B454324A37","Nullam feugiat placerat velit.","2023-1-9 00:00:00","2023-1-22 00:00:00","0","magna. Cras convallis convallis dolor.","odio. Nam",14.58),
  (2,"9D73FA4C-745A-68C1-302C-689E5E31DB0C","ac mattis velit justo","2023-1-17 00:00:00","2023-2-18 00:00:00","0","dui. Cras pellentesque. Sed","pede et risus.",16.64),
  (3,"552A5439-4A22-DB12-7092-75C35623CC68","Lorem ipsum dolor sit","2023-1-22 00:00:00","2023-1-22 00:00:00","1","lorem vitae odio sagittis semper.","interdum. Nunc sollicitudin",14.29),
  (4,"BC5A924D-481B-3D5B-64D2-F6FAE0C535F9","dolor sit amet, consectetuer adipiscing","2023-2-5 00:00:00","2023-2-20 00:00:00","0","arcu. Vestibulum ante ipsum","cubilia Curae Phasellus",22.99),
  (5,"36538480-D44A-6B7D-FF89-518EC99602A9","placerat, orci lacus vestibulum lorem,","2023-1-12 00:00:00","2023-2-11 00:00:00","0","Maecenas ornare egestas ligula. Nullam","nec orci.",13.12),
  (6,"98893C1B-BE5A-1A6C-1EA5-8193F7333A6B","Sed eu eros.","2023-1-14 00:00:00","2023-3-6 00:00:00","0","quis turpis","tristique neque venenatis lacus.",12.89),
  (7,"543AA046-7D5B-ABCF-DE25-A18DED18D556","accumsan convallis, ante","2023-2-15 00:00:00","2023-2-15 00:00:00","1","iaculis enim, sit amet ornare","In nec orci. Donec nibh.",11.97),
  (8,"18098361-A6AE-6B7C-2941-931613C7E7C8","quam. Pellentesque","2023-2-3 00:00:00","2023-1-13 00:00:00","1","0n, lacinia at, iaculis","ut, nulla. Cras eu",13.21),
  (9,"F5752E71-D34D-11B2-4267-CD2FAB1C882D","at, velit. Pellentesque ultricies dignissim","2023-2-3 00:00:00","2023-2-3 00:00:00","0","lobortis quam a","nec quam. Curabitur",16.88),
  (10,"26A45A53-B7CA-CB66-D51B-59C1FC516257","libero est, congue","2023-1-19 00:00:00","2023-2-13 00:00:00","1","Aenean sed pede","lorem, auctor quis, tristique",17.76);
...
INSERT INTO `Livraison` (`livraison_id`,`livraison_num`,`livraison_NbColis`,`livraison_dateExpedition`,`livraison_dateLivraison`,`livraison_bonLivraison`,`client_id`, `commande_id`)
VALUES
  (1,"E1B7E146-BED8-B7A4-8623-F6B454324A37",2,"2023-1-3","2023-1-6","1",8,1),
  (2,"9D73FA4C-745A-68C1-302C-689E5E31DB0C",1,"2023-1-12","2023-1-15","1",10,2),
  (3,"552A5439-4A22-DB12-7092-75C35623CC68",2,"2023-1-24","2023-1-27","0",7,3),
  (4,"BC5A924D-481B-3D5B-64D2-F6FAE0C535F9",3,"2023-1-31","2023-2-3","0",2,4),
  (5,"36538480-D44A-6B7D-FF89-518EC99602A9",2,"2023-2-5","2023-2-8","0",3,5),
  (6,"98893C1B-BE5A-1A6C-1EA5-8193F7333A6B",3,"2023-2-15","2023-2-18","1",3,6),
  (7,"543AA046-7D5B-ABCF-DE25-A18DED18D556",2,"2023-2-16","2023-2-19","0",8,7),
  (8,"18098361-A6AE-6B7C-2941-931613C7E7C8",2,"2023-2-25","2023-2-28","0",5,8),
  (9,"F5752E71-D34D-11B2-4267-CD2FAB1C882D",3,"2023-3-2","2023-3-5","1",2,8),
  (10,"26A45A53-B7CA-CB66-D51B-59C1FC516257",3,"2023-3-24","2023-3-27","0",9,10);

-- ALIMENTATION TABLE CONTIENT ----------------------------------------------------------------------------------------------

INSERT INTO `Contient` (`produit_id`,`livraison_id`,`quantite_livree`)
VALUES
  (1,1,1),
  (2,2,1),
  (3,3,2),
